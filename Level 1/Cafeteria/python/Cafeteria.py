...
def getMaxAdditionalDinersCount(N: int, K: int, M: int, S: List[int]) -> int:
    ...
    for i in range(M):
        ...
        maxAdditionalDinersCount += getMaxDinersBetweenSeats(nextOccupiableSeat, curSeat - K - 1, K)
    ...
    maxAdditionalDinersCount += getMaxDinersBetweenSeats(nextOccupiableSeat, N, K)
